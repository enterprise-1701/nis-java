...
public class NISDataProviderNWAPI_v1_AutoloadTooSmall {
    @DataProvider(name = AppConstants.DATA_PROVIDER)
    public static Object[][] dataProvider(Method method) throws Throwable {

    	String className = method.getDeclaringClass().getSimpleName();
        String testDatafilePath = AppConstants.NIS_TEST_DATA_FOLDER_NWAPI_v1_AutoloadTooSmall+"/"+ className +".json";
